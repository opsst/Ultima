...
class _ProductView2State extends State<ProductView2> {
  ...
  startScrape() async {
    ...
    // );
    var my = await scape.getSuggest(Get.find<userController>().fragrance.value[Get.arguments].l_link.value[0]);
    // print(my);
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            Get.find<userController>().fragrance.value[Get.arguments].p_brand.value,style: GoogleFonts.inter(fontWeight: FontWeight.w600,color: Color(0xFF9D9D9D)),
                          ),
                          SizedBox(height: .5.h,),
                          Text(
                            Get.find<userController>().fragrance.value[Get.arguments].p_name.value,maxLines: 2,style: GoogleFonts.inter(fontWeight: FontWeight.w700,color: Colors.black,fontSize: 18.sp),
                          )
                        ],),
                    ),
                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        width: 100.w,
                        // color: Colors.black,
                        child:Image.network(Get.find<userController>().fragrance.value[Get.arguments].p_img.value),
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                            ...
                            child: Text(Get.find<userController>().fragrance.value[Get.arguments].p_desc.value,maxLines: !isShow?5:100,overflow: TextOverflow.ellipsis,style: GoogleFonts.inter(color: Color(0xFF9FA2A8),fontSize: 15.sp,fontWeight: FontWeight.w500),)),
                      ),
                      !isShow&&Get.find<userController>().fragrance.value[Get.arguments].p_desc.value.length>250?GestureDetector(
                        onTap: (){
                          setState(() {
                            isShow = !isShow;
                          });
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: GestureDetector(
                                onTap: (){
                                  Get.find<userController>().url.value = Get.find<userController>().fragrance.value[Get.arguments].l_link.value[0];
                                  Get.to(
                                          () => PointNavigatedView()
                                  );
